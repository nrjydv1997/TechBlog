...
<title><%=post.getpTitle() %>||TechBlog by Learn code with Neeraj</title>
<link rel="stylesheet"
				...
				<div class="col-md-8 offset-md-2">
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="row my-3 row-user">
								...
								<%
									...
									User userPosted=(User)userDao.getUserByUserId(post.getUserId());
										
								%>
								
									<p class="post-user-info"><a href="#!"><%=userPosted.getName()%></a> has posted:</p>
								</div>
						...
						<div class="card-footer primary-background">
							...
							%>
							<a href="#!" onclick="doLike(<%=post.getpId() %>,<%=user.getId() %>)" class="btn btn-outline-light btn-sm"><i class="fa fa-thumbs-o-up"></i><span class="like-counter"><%=likeDao.countLikeOnPost(post.getpId()) %></span></a>
